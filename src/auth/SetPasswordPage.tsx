    ...
    <div className="login-page">
      <div className="login-card" role="main" aria-label="Set your password">
        <div className="login-header">
          ...
          <p className="login-subtitle">Welcome — set your password</p>
        </div>
        <form className="login-form" onSubmit={handleSubmit} noValidate>
          <p style={{ margin: '0 0 16px', fontSize: '0.875rem', color: '#6b7280' }}>
            Create a password for your account. You'll use it to sign in from now on.
          </p>
          ...
          <div className="form-group">
            ...
            <input
              ...
              value={password} onChange={e => setPasswordVal(e.target.value)}
